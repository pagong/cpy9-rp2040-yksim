...
- If pin GP15 is NOT connected to GND when the pico starts up,
  make the filesystem writeable by CircuitPython.
- If pin GP15 is connected to GND when the pico starts up,
...
WRpin = digitalio.DigitalInOut(board.GP15)
